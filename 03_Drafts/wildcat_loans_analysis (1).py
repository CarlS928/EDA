...
relative to the current working directory. Chart images are saved to an "outputs" folder (created if needed)
...
# ----------------------------------------------------------------------
def main():
    file_path = sys.argv[1] if len(sys.argv) > 1 else os.path.join("02_Data", "Raw", "wildcat_loans_clean.csv")
